...
public class SolveAdapter extends RecyclerView.Adapter<SolveAdapter.HistoryViewHolder> {
private Context mCtx;
private List<SolveAdapterList> productList;

public SolveAdapter(Context mCtx, List<SolveAdapterList> productList) {
        this.mCtx = mCtx;
...
public int getItemCount() {
    ...
    class HistoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(mCtx, viewSolveDetail.class);
